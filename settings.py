...
CHANNEL_DEFAULT_ROUTING = 'trust.routing.channel_routing'
# don't share this with anybody.
SECRET_KEY = '!*tb9k1(g$v(-6t01(1oe!w06_s_9%&@sz@_nipnefw9+$m(fx'
...
SESSION_CONFIGS = [
    ...
    # },
    # {
    #     'name': 'trust_simple_focus',
    #     'display_name': "Trust Game (measuring focus)",
    #     'num_demo_participants': 1,
    #     'app_sequence': ['trust_simple_focus'],
    # },
]
